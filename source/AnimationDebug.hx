...
class AnimationDebug extends MusicBeatState
{
	...
	override function create()
	{
		...
		background = new FlxSprite(-600, -525).loadGraphic(Paths.loadImage('stageback'));
		front = new FlxSprite(-650, 325).loadGraphic(Paths.loadImage('stagefront'));
		curt = new FlxSprite(-500, -625).loadGraphic(Paths.loadImage('stagecurtains'));
