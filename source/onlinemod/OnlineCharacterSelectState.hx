...
typedef OnlineCharacterMenu = {
    var name:String;
    var characterName:String;
    var portrait:String;
}

class OnlineCharacterSelectState extends MusicBeatState
{
    var menuItems:Array<String> = ['bf', 'tauntbf', 'dad', 'spooky', 'monster', 'pico', 'mom', 'parents-christmas', 'senpai', 'senpai-anngry', 'spirit', 'tankman'];
    ...
    public static var characterShit:Array<OnlineCharacterMenu>;
